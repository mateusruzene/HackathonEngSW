...
\subsection{1. Princípio da Responsabilidade Única (Single Responsibility Principle -- SRP)}
...
\subsection{2. Princípio Aberto/Fechado (Open/Closed Principle -- OCP)}
...
\subsection{3. Princípio da Substituição de Liskov (Liskov Substitution Principle -- LSP)}
...
\subsection{4. Princípio da Segregação de Interfaces (Interface Segregation Principle -- ISP)}
...
\subsection{5. Princípio da Inversão de Dependência (Dependency Inversion Principle -- DIP)}
